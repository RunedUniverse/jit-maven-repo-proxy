...
public class RedirectRepoException extends RepoException {
	...
	public RedirectRepoException(final String reason, final String originalLocation, final List<String> redirects) {
		super(reason);
