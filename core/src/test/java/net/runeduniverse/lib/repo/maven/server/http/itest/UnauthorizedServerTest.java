 ...
 */
package net.runeduniverse.lib.repo.maven.server.http.itest;
...
import net.runeduniverse.lib.repo.maven.server.itest.AServerTest;
import net.runeduniverse.lib.repo.maven.server.itest.dummy.UnauthorizedRepoInstance;

import static org.junit.jupiter.api.Assertions.assertInstanceOf;

public class UnauthorizedServerTest extends AServerTest {

	@Override
	protected void configureRepoInstance(final Map<String, MavenRepositoryInstance> instances) {
		// ensure no one is ever authorized
		instances.computeIfAbsent("maven-central", UnauthorizedRepoInstance::new);
	}
	...
	public void unauthorizedMetadata() throws InterruptedException, TimeoutException {
		...
		try {
			assertInstanceOf(UnauthorizedArtifactException.class, t,
					"missing metadata should throw UnauthorizedArtifactException");
		} catch (Error e) {
			t.printStackTrace();
			throw e;
		}
	...
	public void unauthorizedArtifact() throws InterruptedException, TimeoutException {
		...
		try {
			assertInstanceOf(UnauthorizedArtifactException.class, t,
					"missing artifact should throw UnauthorizedArtifactException");
		} catch (Error e) {
			t.printStackTrace();
			throw e;
		} finally {
