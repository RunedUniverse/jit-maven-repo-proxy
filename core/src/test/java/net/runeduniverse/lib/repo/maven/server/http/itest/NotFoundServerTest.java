...
import net.runeduniverse.lib.repo.maven.server.itest.dummy.NotFoundRepoInstance;

import static org.junit.jupiter.api.Assertions.assertInstanceOf;

public class NotFoundServerTest extends AServerTest {

	@Override
	protected void configureRepoInstance(final Map<String, MavenRepositoryInstance> instances) {
		// ensure no artifact is ever found
		instances.computeIfAbsent("maven-central", NotFoundRepoInstance::new);
	}
