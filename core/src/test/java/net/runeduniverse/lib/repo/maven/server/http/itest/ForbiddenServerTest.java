...
import net.runeduniverse.lib.repo.maven.server.itest.dummy.ForbiddenRepoInstance;

import static org.junit.jupiter.api.Assertions.assertInstanceOf;

public class ForbiddenServerTest extends AServerTest {

	@Override
	protected void configureRepoInstance(final Map<String, MavenRepositoryInstance> instances) {
		// ensure nothing is ever allowed
		instances.computeIfAbsent("maven-central", ForbiddenRepoInstance::new);
	}
