 ...
 */
/*
 * NOTE: following Class is a 1-to-1 copy of the
 * org.apache.maven.artifact.versioning.ComparableVersion from org.apache.maven:maven-artifact
 * which is included in maven-core.
 *
 * Therefore be informed that the Copyright lies with the Apache Software Foundation (ASF)
